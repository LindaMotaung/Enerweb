...
namespace RecipeShare.Persistence.Migrations
{
    ...
    [Migration("20250610143217_AddCreatedByDateFields")]
    partial class AddCreatedByDateFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecipeShare.Domain.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 6, 10, 16, 32, 16, 114, DateTimeKind.Local).AddTicks(6016),
                            DateModified = new DateTime(2025, 6, 10, 16, 32, 16, 116, DateTimeKind.Local).AddTicks(6764),
