...
namespace RecipeShare.Persistence.Migrations
{
    ...
    [Migration("20250610132921_InitialMigration")]
            ...
            modelBuilder.Entity("RecipeShare.Domain.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 6, 10, 15, 29, 20, 362, DateTimeKind.Local).AddTicks(1020),
                            DateModified = new DateTime(2025, 6, 10, 15, 29, 20, 364, DateTimeKind.Local).AddTicks(5122),
